export const defaultPatch = {
  ...
  modulation: {
    ...
    params: {
      '/Euclid Van der Pol/Clock/Clock': 203.8649107152844,
      '/Euclid Van der Pol/Clock/Euclid N': 5.800000000000001,
  ...
  synth: {
    ...
    mods: {
      ...
      '/Euclid Van der Pol/Osc 2/Feedback': {
        source: '-',
        amount: -0.5583989184875606,
      },
      '/Euclid Van der Pol/Osc 2/dt': {
        source: '-',
        amount: 0.009711214449812409,
      },
      '/Euclid Van der Pol/Osc 2/Limit': {
        source: '-',
        amount: 0.044968476423105745,
      },
      '/Euclid Van der Pol/Osc 2/DC Block': {
        source: '-',
        amount: 0.0872473793340861,
      },
      '/Euclid Van der Pol/Osc 2/Spread': {
        source: 'lfn',
        amount: 0.6316982515377157,
      },
